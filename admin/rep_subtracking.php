  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>Operational</li>
        <li class="active">Report Table Subtracking</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
				<h4>Report Table Subtracking</h4>
      <div class="panel-body text-nowrap">
          ...
          <thead style="background-color:#367FA9">
            <tr>
                ...
                <th style="color: #FFFFFF">Tracking Number </th>
                <th style="color: #FFFFFF">Tracking Name</th>
                <th style="color: #FFFFFF">Number Truck</th>
                    ...
                    while($row = $query->fetch_assoc()){
                          echo "
                            <tr>
                              ...
                              <td align='center'>".$row['number_subtracking']."</td>
                              <td align='left'>".$row['tracking_name']."</td>
                              <td align='left'>".$row['number_truck']."</td>
                              <td>
