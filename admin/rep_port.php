  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>Operational</li>
        <li class="active">Report Table Barang</li>
      </ol>
    </section>
      ...
      <div class="row" style="margin-top: 55px;">
        ...
        <thead style="background-color:#367FA9">
            <tr>
							...
							<th style="color: #FFFFFF">Arr/Dep </th>
              <th style="color: #FFFFFF">Location </th>
							<th style="color: #FFFFFF">Port Name</th>
            ...
            $no = 1;
              ...
              while($row = $query->fetch_assoc()){
                  ...
                  <tr>
                    ...
                    <td align='left'>".$row['port_name']."</td>
                    <td align='center'>
