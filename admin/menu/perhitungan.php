...
<?php
	...
	if(isset($_GET['nilai_user'])){
		...
		<div class="module">
		<div class="module-head">
			<h3>Perhitungan Nilai Uji -- <?php echo $nama_lw['lowongan']; ?></h3>
		</div>
		<div class="module-body table" style="margin-left: 20px">
		<?php
			...
			for($i=0;$i<$jml_pelamar;$i++){
				...
				echo "<b>Pelamar dengan id </b>"."<u>" . $ar_pelamar[$i] . "</u><br>";
				$ib=0;
				$vkt_s = 1;
				while($k = $loop2->fetch()){
				...
				echo "Vektor s pelamar " . $ar_pelamar[$i] . " = " . $vkt_s . "<br><br>";
