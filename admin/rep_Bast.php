      ...
      <div class="panel-body table-responsive text-nowrap">
        ...
        <thead style="background-color:#367FA9">
          <tr>
							...
							<th style="color: #FFFFFF">No BA</th>
              ...
              <tbody>
						  <?php
                    $no = 1;
                    $sql = "SELECT * FROM bast where bast.code";
                    ...
                    while($row = $query->fetch_assoc()){
                        ...
                        <tr>
                          ...
                          <td align='center'>
                            ...
                            <a title='print' data-placement='right' class='btn btn-warning btn-sm print' data-toggle='modal' href='#printModal' data-id=".$row['code']."><i class='fa  fa-print'></i>Print</a>
                          </td>
                        </tr>" ;
                            $no++;
                          }
...
$(document).ready(function() {
  ...
  $('.print').click(function(){
        ...
        $('input#code').val(code);
        $('#btn-print').attr('href','print_form_bast.php?code='+code);
    })

    $('.trash').click(function(){
        var id=$(this).data('id');
        $('.hps').attr('href','delete_BA.php?id='+id);
    })
