      ...
      <div class="panel-body text-nowrap">
          ...
          <thead style="background-color:#367FA9">
              <tr>
                ...
                <th style="color: #FFFFFF">Name of sales </th>
            ...
            $no = 1;
              ...
              while($row = $query->fetch_assoc()){
                  ...
                  <tr>
                    ...
                    <td align='left'>".$row['cp_sales']."</td>
                    <td align='left'>".$row['email']."</td>
                    <td align='left'>".$row['telephone']."</td>
                    <td align='center'>
                      <a href='edit_delete/edit_sales.php?id=".$row['id']."' class='btn btn-success btn-sm' ><i class='fa fa-edit'></i> Edit</a>
                      <a href='edit_delete/delete_sales.php?id=".$row['id']."' class='btn btn-danger btn-sm' ><i class='fa fa-delete'></i> Delete</a>
                    </td>
                  </tr>" ;
                    $no++;
                  }
